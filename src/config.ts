...
export function getConfig(args: string[]) {
    ...
    const useLetters = parsedArgs.letters !== undefined ? parsedArgs.letters : true;
    const useNumbers = parsedArgs.numbers !== undefined ? parsedArgs.numbers : true;
    const useSpecial = parsedArgs.special !== undefined ? parsedArgs.special : false;
